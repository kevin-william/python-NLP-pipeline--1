...
CAMINHO_PARQUET_ENTRADA = os.path.join(DIRETORIO_BASE, "input", "1100-artigos_wikipedia-formatados_lemmatizacao.parquet")
...
CAMINHO_LOG = os.path.join(DIRETORIO_SAIDA, "1100-artigos_wikipedia-formatados_lemmatizacao.log")

# Ordem dos metodos de embedding a treinar e disponibilizar na busca.
METODOS_EMBEDDING = ["tfidf", "word2vec"]
...
PARAMS_TFIDF = {"max_features": 5000, "min_df": 5, "norm": "l2"}

# Parametros de treino do Word2Vec (Gensim).
PARAMS_WORD2VEC = {"vector_size": 100, "window": 5, "min_count": 5, "epochs": 50, "seed": 42}

# Habilita/desabilita a geracao do grafico t-SNE apos o treino.
HABILITAR_TSNE = True

# Parametros de reducao de dimensionalidade do t-SNE.
PARAMS_TSNE = {"n_components": 2, "perplexity": 30, "n_iter": 4000, "random_state": 42}
...
CAMINHO_SAIDA_TSNE = os.path.join(DIRETORIO_SAIDA, "1100-artigos_wikipedia-formatados_lemmatizacao.png")
